...
public record AdminStudentDto(
    ...
    : StudentDto(Id, Email, RegistrationStage, FirstName, LastName, Patronymic, ContactPhone, ContactEmail,
        CityId, CityName, Gender, BirthDate, AvatarUrl, IsForeign, Status, UniversityId, FacultyId,
        DepartmentId, StudyDirectionId, CourseNumber, StudyForm, CourseIds, Courses, CreatedAt, ResumeId);
